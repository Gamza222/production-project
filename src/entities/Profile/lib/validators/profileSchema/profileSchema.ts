...
import { type formFieldMetadata } from 'shared/model/types/formFieldMetadata/formFieldMetadata'
import { type ProfileUpdateData } from '../../../model/types/profile'
...
export const createProfileSchema = (t: TFunction) => z.object({
    ...
    username: z.string()
        ...
        .regex(/^[a-zA-Zа-яА-Я0-9_]+$/, t('profile-validation.Имя_пользователя.invalidChars')),
